...
banks = [
  ...
  { name: 'בנק מזרחי טפחות',     sftp_host: 'sftp.mizrahi-tefahot.co.il',   sftp_port: 2222, sftp_remote_path: '/daily',               sftp_username: 'octobankx_mz',      sftp_password: 'mz#d@ily' },
  ...
  { name: 'פסגות חבר בורסה',       sftp_host: 'sftp.psagot.co.il',            sftp_port: 22,   sftp_remote_path: '/broker/daily',        sftp_username: 'octobankx_psagot',  sftp_password: 'ps@g0t!' },
  { name: 'מיטב חבר בורסה',        sftp_host: 'sftp.meitav.co.il',            sftp_port: 22,   sftp_remote_path: '/reports',             sftp_username: 'octobankx_meitav',  sftp_password: 'me1tav#r' },
  { name: 'אקסלנס חבר בורסה',     sftp_host: 'sftp.excellence.co.il',        sftp_port: 22,   sftp_remote_path: '/statements',          sftp_username: 'octobankx_exc',     sftp_password: 'exc3l!nce' },
